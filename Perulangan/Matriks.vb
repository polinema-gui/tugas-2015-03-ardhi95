Public Class Matriks
    ...
    Private Sub btn_proses_Click(sender As Object, e As EventArgs) Handles btn_proses.Click
        Try
            Dim barisMatriks1 As Integer = matrik1.Lines.Count
            Dim kolomMatriks1 As Integer = matrik1.Lines.ElementAt(0).Split(" ").Length
            Dim barisMatriks2 As Integer = matrik1.Lines.Count
            Dim kolomMatriks2 As Integer = matrik1.Lines.ElementAt(0).Split(" ").Length
